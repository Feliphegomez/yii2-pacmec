...
<header class="px-0 border-bottom"> 
    <div class="container-fluid px-3">
        <?php
            NavBar::begin([
                // 'brandLabel' => Yii::$app->name,
                'brandLabel' => Html::img(Yii::getAlias($menus->top_primary->brand_image), ['alt'=>Yii::$app->name, 'height' => '32', 'class' => 'me-2']),
                            ...
                            [
                                ...
                                'items' => array_merge(isset(Yii::$app->params['menus']['my_account']->items) ? array_map(function($model) {
                                    ...
                                    '<hr class="dropdown-divider">',
                                        Html::beginForm(['/site/default/logout'])
                                        . Html::submitButton(
                                            'Cerrar sesion',
                                            ['class' => 'dropdown-item']
                                        )
            ...
            NavBar::begin([
                ...
                if (Yii::$app->user->isGuest) {
                    echo '<div class="text-end">';
                        echo '<a href="'.Url::toRoute(['/login']).'" class="btn btn-light text-dark me-2">Ingresar</a>';
                        echo '<a href="'.Url::toRoute(['/signup']).'" class="btn btn-primary">Registrarte</a>';
                    echo '</div>';
                } else {
